package jp.co.okayama.guessarena.custom;
...
public class PcSideMenuEnabledLayout extends FrameLayout {
    ...
    public void init(
        ...
        // options
        mHiddenViewMargin = hiddenViewMargin < 0 ? Utils.pxFromDp(context, DEFAULT_HIDDEN_VIEW_MARGIN_IN_DP) : hiddenViewMargin;
        ...
        mGestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onDown(MotionEvent e) {
                ...
                mShouldHandle = Utils.motionEventOnView(e, mMidView);
            ...
            public boolean onSingleTapUp(MotionEvent e) {
                ...
                if (mSidePos != SidePosition.MID && Utils.motionEventOnView(e, mMidView)) {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                Utils.removeOnGlobalLayoutListener(PcSideMenuEnabledLayout.this, this);
